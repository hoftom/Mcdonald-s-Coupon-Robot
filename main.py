...
class MainForm(object):
    ...
    def button_clicked(self):
        Form.hide()
        self.__backend(self.comboBox.currentText(), self.spinBox.value())
        Form.show()

    def __select_options(self, selected_type):
    ...
    def __normalize_code(self, string):
    ...
    def __delete_codeline(self, selected_list):
    ...
    def __backend(self, selected_type, asked_amount):
            selected_list = self.__select_options(selected_type)
                ...
                if successful_upload_number + 1 <= asked_amount:
                    if row != "\n":
                        ...
                        with sync_playwright() as p:
                            ...
                            # Enter code
                            code = self.__normalize_code(row)
                            ...
                            if initial_content != updated_content:
                                ...
                                # Nemed?
                                genders = ['//*[@id="22"]/div[5]/div[1]/div[2]/span',
                                           '//*[@id="22"]/div[5]/div[2]/div[2]/span']

                                tenth_radio_button_xpath = random.choice(genders)
                                page.click(tenth_radio_button_xpath)

                                # Életkorod?
                                ages = ['//*[@id="23"]/div[5]/div[1]/div[2]/span',
                                        '//*[@id="23"]/div[5]/div[2]/div[2]/span',
                                        '//*[@id="23"]/div[5]/div[3]/div[2]/span',
                                        '//*[@id="23"]/div[5]/div[4]/div[2]/span',
                                        '//*[@id="23"]/div[5]/div[5]/div[2]/span',
                                        '//*[@id="23"]/div[5]/div[6]/div[2]/span']
                                ...
                                # Close window
                                time.sleep(5)
                                self.__delete_codeline(selected_list)
